...
describe('AuthStore', () => {
    ...
    it('should provide token getter function', async () => {
        ...
        // Set access token manually for this test
    ...
    it('should set loading state during login', async () => {
        ...
        const loginPromise = new Promise<{ access_token: string; token_type: string }>((resolve) => {
